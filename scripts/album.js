...
var setupSeekBars = function() {
  ...
  $seekBars.find('.thumb').mousedown(function(event) {
    ...
    // mousemove allows .thumb to be dragged continuously
    ...
    // unbind() removes prior listeners
    // failure to unbind results in continued movement after mouse release
...
// pause or resume playback using central pause/play button on player bar
